"""Dependency-free in-process ASGI acceptance for TASK-17."""
...
async def main() -> None:
    with tempfile.TemporaryDirectory(prefix="contractiq-task17-asgi-") as root:
    ...
    print("TASK-17 ASGI acceptance: PASS")
