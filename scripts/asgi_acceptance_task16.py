"""Dependency-free in-process ASGI acceptance for TASK-16."""
...
async def main() -> None:
    with tempfile.TemporaryDirectory(prefix="contractiq-task16-asgi-") as root:
